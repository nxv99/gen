...
f = open(out_file,'wb')
r1 = requests.get("https://api.proxyscrape.com/v2/?request=getproxies&protocol=socks4&timeout=5000&country=all")
f.write(r1.content)
f.close()
...
___0 = "uBDUZx3kpw" # Invite Code 
____0 = 100000000000000000000000000000000000000000000000000 # Thread Amount
_________0 = 'iMagine GEN'
__________0 = 4 #Random Text
